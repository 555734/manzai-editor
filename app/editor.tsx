...
import { useLocalSearchParams, useNavigation, useRouter } from 'expo-router'; // ★ useNavigationを追加
...
export default function EditorScreen() {
    ...
    const navigation = useNavigation(); // ★ 履歴チェック用に追加
    ...
    const handleBack = () => {
        // 履歴があろうがなかろうが、強制的にトップページ（ネタ帳）に戻る
        router.replace('/');
    };
